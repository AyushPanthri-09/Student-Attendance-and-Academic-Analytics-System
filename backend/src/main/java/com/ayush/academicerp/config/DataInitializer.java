...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeSampleData() {
        ...
        // Create students
        Student[] cseStudents = createStudentsForDepartment(cseDept, 20, 3, 4, cseCourse);
        Student[] eceStudents = createStudentsForDepartment(eceDept, 15, 3, 4, eceCourse);
        Student[] meStudents = createStudentsForDepartment(meDept, 10, 3, 4, meCourse);
        Student[] ceStudents = createStudentsForDepartment(ceDept, 10, 3, 4, ceCourse);
