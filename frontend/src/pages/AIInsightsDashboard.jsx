  ...
  return (
    <div className="space-y-6">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-1">{realTimeMetrics.activeStudents || 0}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-1">{realTimeMetrics.engagementRate || 0}%</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-1">{realTimeMetrics.accuracy || 0}%</p>
            </div>
                ...
                return (
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-gray-500">{(student.riskScore * 100).toFixed(1)}% risk</p>
                    </div>
                  </div>
                );
              })}
      ...
      <motion.div
        ...
        className="bg-white rounded-xl shadow-lg p-6"
      >
        <h2 className="text-xl font-bold text-gray-800 mb-4">Student Sentiment Analysis</h2>
