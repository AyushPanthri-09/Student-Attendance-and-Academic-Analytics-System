...
export default function StudentAttendance() {
  ...
  useEffect(() => {
    applyFilters();
  }, [attendanceRecords, dateRange, department]);
  ...
  const applyFilters = () => {
    ...
    // Department filter (if needed - though it's per student, maybe filter by subject department)
    // For now, skip department filter as it's per student
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div className="mt-4">
          <button
            onClick={() => setDateRange({start: "", end: ""}) & setDepartment("")}
